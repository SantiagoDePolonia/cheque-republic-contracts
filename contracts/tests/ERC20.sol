...
// Note: Only the constructor has been changed. It is used locally only for testing.
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// !!!! IT SHOULD NOT BE DEPLOYED TO ANY PRODUCTION ENVIRONMENT !!!!!
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_, address owner) {
        _name = name_;
        _symbol = symbol_;
        _balances[owner] = 10000000000000000000; // 10 ETH
    }
